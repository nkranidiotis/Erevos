...
def _resource_path(rel: str) -> Path:
    """Resolve a bundled-resource path. Works both in dev and in a PyInstaller bundle.

    In a PyInstaller onedir build, `sys._MEIPASS` points at `<bundle>/_internal/`,
    which is where files declared via the spec `datas` list end up.
    In dev, fall back to the repo root (two levels up from this file).
    """
...
class SplashScreen(QDialog):
    ...
    LOGO_PATH = _resource_path("ui/logo.png")
